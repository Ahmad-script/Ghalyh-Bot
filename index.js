...
//
const BotName = 'Ghalyh bot'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/ghlyhalamn'; // Nama Instagramlu cok
const whatsapplu = 'http://wa.me/+6285766853909'; // Nomor whatsapplu cok
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Ghalyh`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Ghalyh`)
})
